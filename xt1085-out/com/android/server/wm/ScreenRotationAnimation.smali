...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/DisplayContent;Landroid/view/SurfaceSession;ZZZ)V
    ...
    :goto_cb
    const-string/jumbo v1, "ro.sf.hwrotation"
    ...
    if-eq v12, v1, :cond_ea

    .line 245
    const/4 v1, 0x3

    if-ne v12, v1, :cond_14f
    ...
    :try_end_140
    .catch Landroid/view/Surface$OutOfResourcesException; {:try_start_fe .. :try_end_140} :catch_164
    .catchall {:try_start_fe .. :try_end_140} :catchall_16e
    ...
    :try_end_143
    .catchall {:try_start_140 .. :try_end_143} :catchall_16e
    ...
    if-eq v12, v1, :cond_15a

    .line 254
    const/4 v1, 0x3

    if-ne v12, v1, :cond_15f
    ...
    :try_end_16d
    .catchall {:try_start_165 .. :try_end_16d} :catchall_16e
...
.method private startAnimation(Landroid/view/SurfaceSession;JFIIZII)Z
    ...
    :try_end_a4
    .catch Landroid/view/Surface$OutOfResourcesException; {:try_start_7f .. :try_end_a4} :catch_169
    .catchall {:try_start_7f .. :try_end_a4} :catchall_177
    ...
    :try_end_da
    .catch Landroid/view/Surface$OutOfResourcesException; {:try_start_b0 .. :try_end_da} :catch_17c
    .catchall {:try_start_b0 .. :try_end_da} :catchall_18a
    ...
    :try_end_167
    .catch Landroid/view/Surface$OutOfResourcesException; {:try_start_145 .. :try_end_167} :catch_169
    .catchall {:try_start_145 .. :try_end_167} :catchall_177
    ...
    :try_end_172
    .catchall {:try_start_16a .. :try_end_172} :catchall_177
    ...
    invoke-static {v2, v3, v11}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_185
    .catchall {:try_start_17d .. :try_end_185} :catchall_18a
