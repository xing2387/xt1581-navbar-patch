...
.method private getPackageLPw(Ljava/lang/String;Lcom/android/server/pm/PackageSetting;Ljava/lang/String;Lcom/android/server/pm/SharedUserSetting;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IIILandroid/os/UserHandle;ZZLjava/lang/String;Ljava/util/List;)Lcom/android/server/pm/PackageSetting;
    ...
    .line 768
    .local v25, "s":Lcom/android/server/pm/PackageSignatures;
    move-object/from16 v0, p2
    ...
    .line 857
    .end local v25    # "s":Lcom/android/server/pm/PackageSignatures;
    :goto_112
    ...
    .line 724
    .local v22, "allUserInfos":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/UserInfo;>;"
    if-eqz v22, :cond_19f
    ...
    .local v30, "userInfo$iterator":Ljava/util/Iterator;
    :goto_18a
    ...
    .line 737
    .end local v22    # "allUserInfos":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/UserInfo;>;"
    .end local v29    # "userInfo":Landroid/content/pm/UserInfo;
    .end local v30    # "userInfo$iterator":Ljava/util/Iterator;
    :cond_19f
    move-object/from16 v0, p7
    ...
    .local v27, "user$iterator":Ljava/util/Iterator;
    :goto_1fe
    ...
    .line 806
    invoke-virtual/range {v4 .. v21}, Lcom/android/server/pm/PackageSetting;->setUserState(IJIZZZZZLjava/lang/String;Landroid/util/ArraySet;Landroid/util/ArraySet;ZIILandroid/util/ArraySet;Landroid/util/ArraySet;)V
    ...
    .end local v24    # "installUserId":I
    .end local v26    # "user":Landroid/content/pm/UserInfo;
    .end local v27    # "user$iterator":Ljava/util/Iterator;
    :cond_24e
    const/16 v24, 0x0

    .restart local v24    # "installUserId":I
    goto :goto_1f6

    .line 802
    .restart local v26    # "user":Landroid/content/pm/UserInfo;
    .restart local v27    # "user$iterator":Ljava/util/Iterator;
    :cond_251
    const/4 v9, 0x1
    ...
    .line 827
    .local v23, "dis":Lcom/android/server/pm/PackageSetting;
    if-eqz v23, :cond_2d8
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/server/pm/PackageSetting;->getPermissionsState()Lcom/android/server/pm/PermissionsState;
    ...
    .line 862
    .end local v23    # "dis":Lcom/android/server/pm/PackageSetting;
    :cond_2e2
    if-eqz p14, :cond_2ed
...
.method createNewUserLI(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/Installer;I)V
    ...
    :try_end_a0
    .catch Lcom/android/internal/os/InstallerConnection$InstallerException; {:try_start_8e .. :try_end_a0} :catch_a1
...
.method readLPw(Ljava/util/List;)Z
    ...
    :try_end_17
    .catch Ljava/io/IOException; {:try_start_c .. :try_end_17} :catch_649
    ...
    :try_end_57
    .catch Ljava/io/IOException; {:try_start_17 .. :try_end_57} :catch_64c
    ...
    .catch Ljava/io/IOException; {:try_start_77 .. :try_end_12a} :catch_210
    ...
    :try_end_20e
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_1f8 .. :try_end_20e} :catch_12b
    .catch Ljava/io/IOException; {:try_start_1f8 .. :try_end_20e} :catch_210
    ...
    invoke-interface {v0, v4, v3}, Lorg/xmlpull/v1/XmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    :try_end_311
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_24a .. :try_end_311} :catch_12b
    .catch Ljava/io/IOException; {:try_start_24a .. :try_end_311} :catch_210
    ...
    :try_end_31d
    .catch Ljava/lang/NumberFormatException; {:try_start_31a .. :try_end_31d} :catch_336
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_31a .. :try_end_31d} :catch_12b
    .catch Ljava/io/IOException; {:try_start_31a .. :try_end_31d} :catch_210
    ...
    invoke-interface {v0, v4, v3}, Lorg/xmlpull/v1/XmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    :try_end_415
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_320 .. :try_end_415} :catch_12b
    .catch Ljava/io/IOException; {:try_start_320 .. :try_end_415} :catch_210
    ...
    :try_end_41e
    .catch Ljava/lang/IllegalArgumentException; {:try_start_416 .. :try_end_41e} :catch_420
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_416 .. :try_end_41e} :catch_12b
    .catch Ljava/io/IOException; {:try_start_416 .. :try_end_41e} :catch_210
    ...
    :try_end_4ee
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_421 .. :try_end_4ee} :catch_12b
    .catch Ljava/io/IOException; {:try_start_421 .. :try_end_4ee} :catch_210
...
.method readPackageRestrictionsLPr(I)V
    ...
    :try_end_19
    .catch Ljava/io/IOException; {:try_start_10 .. :try_end_19} :catch_d9
    ...
    const-string/jumbo v40, "Cleaning up stopped packages file "
    ...
    :try_end_51
    .catch Ljava/io/IOException; {:try_start_19 .. :try_end_51} :catch_37a
    ...
    invoke-virtual/range {v4 .. v21}, Lcom/android/server/pm/PackageSetting;->setUserState(IJIZZZZZLjava/lang/String;Landroid/util/ArraySet;Landroid/util/ArraySet;ZIILandroid/util/ArraySet;Landroid/util/ArraySet;)V
    :try_end_9d
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_53 .. :try_end_9d} :catch_9e
    .catch Ljava/io/IOException; {:try_start_53 .. :try_end_9d} :catch_375
    ...
    invoke-virtual/range {v27 .. v27}, Lorg/xmlpull/v1/XmlPullParserException;->toString()Ljava/lang/String;
    ...
    invoke-direct {v0, v1}, Ljava/io/FileInputStream;-><init>(Ljava/io/File;)V
    :try_end_e8
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_df .. :try_end_e8} :catch_9e
    .catch Ljava/io/IOException; {:try_start_df .. :try_end_e8} :catch_375
    ...
    .line 1645
    .local v29, "maxAppLinkGeneration":I
    ...
    const-string/jumbo v40, "No package known for stopped package "
    ...
    .line 1750
    .end local v6    # "ps":Lcom/android/server/pm/PackageSetting;
    .end local v29    # "maxAppLinkGeneration":I
    ...
    .restart local v27    # "e":Lorg/xmlpull/v1/XmlPullParserException;
    goto/16 :goto_a1

    .line 1666
    .end local v27    # "e":Lorg/xmlpull/v1/XmlPullParserException;
    .restart local v6    # "ps":Lcom/android/server/pm/PackageSetting;
    .restart local v29    # "maxAppLinkGeneration":I
    ...
    .line 1678
    .local v25, "blockedStr":Ljava/lang/String;
    if-nez v25, :cond_25d
    ...
    .line 1681
    .local v28, "hiddenStr":Ljava/lang/String;
    if-nez v28, :cond_263
    ...
    .end local v28    # "hiddenStr":Ljava/lang/String;
    ...
    .restart local v28    # "hiddenStr":Ljava/lang/String;
    :cond_263
    ...
    .line 1727
    invoke-virtual/range {v6 .. v23}, Lcom/android/server/pm/PackageSetting;->setUserState(IJIZZZZZLjava/lang/String;Landroid/util/ArraySet;Landroid/util/ArraySet;ZIILandroid/util/ArraySet;Landroid/util/ArraySet;)V
    :try_end_2aa
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_e8 .. :try_end_2aa} :catch_18e
    .catch Ljava/io/IOException; {:try_start_e8 .. :try_end_2aa} :catch_2ac
    ...
    .end local v20    # "verifState":I
    .end local v21    # "linkGeneration":I
    .end local v25    # "blockedStr":Ljava/lang/String;
    .end local v28    # "hiddenStr":Ljava/lang/String;
    .end local v29    # "maxAppLinkGeneration":I
    .end local v30    # "name":Ljava/lang/String;
    .end local v31    # "outerDepth":I
    ...
    const-string/jumbo v40, "Unknown element under <stopped-packages>: "
    ...
    :try_end_373
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_2e6 .. :try_end_373} :catch_18e
    .catch Ljava/io/IOException; {:try_start_2e6 .. :try_end_373} :catch_2ac
...
.method writeLPr()V
    ...
    :try_end_4ee
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_27c .. :try_end_4ee} :catch_1e2
    .catch Ljava/io/IOException; {:try_start_27c .. :try_end_4ee} :catch_26c
...
.method writePackageRestrictionsLPr(I)V
    ...
    :try_end_2a8
    .catch Ljava/io/IOException; {:try_start_19f .. :try_end_2a8} :catch_16a
