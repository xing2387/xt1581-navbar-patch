...
.method allResumedActivitiesComplete()Z
    ...
    const-string/jumbo v9, "moveHomeStack, setupComplete:"
    ...
    iget-boolean v7, v7, Lcom/android/server/am/ActivityManagerService;->immediateScreenStatusReq:Z
    ...
    iput-boolean v10, v7, Lcom/android/server/am/ActivityManagerService;->immediateScreenStatusReq:Z

    .line 932
    new-instance v1, Landroid/content/Intent;

    const-string/jumbo v7, "android.intent.action.stk.idle_screen"

    invoke-direct {v1, v7}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 933
    .local v1, "idleScreenIntent":Landroid/content/Intent;
    const-string/jumbo v7, "SCREEN_IDLE"
    ...
    iget v8, v8, Lcom/android/server/am/ActivityManagerService;->mSlotId:I
    ...
    const-string/jumbo v9, "Broadcasting Home idle screen Intent slot="
    ...
    iget v9, v9, Lcom/android/server/am/ActivityManagerService;->mSlotId:I
    ...
    .restart local v3    # "setupComplete":Z
    goto :goto_59
.end method
...
.method final realStartActivityLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ProcessRecord;ZZ)Z
    ...
    invoke-virtual {v5, v6}, Lcom/android/server/am/UserController;->hasStartedUserState(I)Z
    ...
    const-string/jumbo v7, "Skipping start of r="
    ...
    invoke-virtual {v0, v1, v5}, Lcom/android/server/am/ActivityRecord;->startFreezingScreenLocked(Lcom/android/server/am/ProcessRecord;I)V
    ...
    iget-object v7, v5, Lcom/android/server/am/ActivityManagerService;->mConfiguration:Landroid/content/res/Configuration;
    ...
    .line 1241
    :goto_7a
    invoke-virtual {v6, v7, v5}, Lcom/android/server/wm/WindowManagerService;->updateOrientationFromAppTokens(Landroid/content/res/Configuration;Landroid/os/IBinder;)Landroid/content/res/Configuration;
    ...
    invoke-virtual {v5, v0, v1, v6}, Lcom/android/server/am/ActivityManagerService;->updateConfigurationLocked(Landroid/content/res/Configuration;Lcom/android/server/am/ActivityRecord;Z)Z
    ...
    iput-object v5, v0, Lcom/android/server/am/ProcessRecord;->waitingToKill:Ljava/lang/String;

    .line 1249
    move-object/from16 v0, p1

    iget v5, v0, Lcom/android/server/am/ActivityRecord;->launchCount:I

    add-int/lit8 v5, v5, 0x1

    move-object/from16 v0, p1

    iput v5, v0, Lcom/android/server/am/ActivityRecord;->launchCount:I
    ...
    iput-wide v6, v0, Lcom/android/server/am/ActivityRecord;->lastLaunchTime:J
    ...
    iget v5, v0, Lcom/android/server/am/TaskRecord;->mLockTaskAuth:I
    ...
    invoke-virtual {v0, v1, v6, v5, v7}, Lcom/android/server/am/ActivityStackSupervisor;->setLockTaskModeLocked(Lcom/android/server/am/TaskRecord;ILjava/lang/String;Z)V
    ...
    throw v5
    :try_end_fe
    .catch Landroid/os/RemoteException; {:try_start_f2 .. :try_end_fe} :catch_fe
    ...
    iget-boolean v5, v0, Lcom/android/server/am/ActivityRecord;->launchFailed:Z
    ...
    .line 1369
    const-string/jumbo v7, ", giving up"
    ...
    invoke-virtual {v5, v0}, Lcom/android/server/am/ActivityManagerService;->appDiedLocked(Lcom/android/server/am/ProcessRecord;)V
    ...
    .line 1273
    .local v18, "results":Ljava/util/List;, "Ljava/util/List<Landroid/app/ResultInfo;>;"
    const/16 v19, 0x0

    .line 1274
    .local v19, "newIntents":Ljava/util/List;, "Ljava/util/List<Lcom/android/internal/content/ReferrerIntent;>;"
    if-eqz p3, :cond_160
    ...
    .line 1281
    .end local v18    # "results":Ljava/util/List;, "Ljava/util/List<Landroid/app/ResultInfo;>;"
    .end local v19    # "newIntents":Ljava/util/List;, "Ljava/util/List<Lcom/android/internal/content/ReferrerIntent;>;"
    :cond_160
    if-eqz p3, :cond_1ab
    ...
    .line 1287
    const-string/jumbo v5, "am_restart_activity"
    ...
    .line 1287
    invoke-virtual/range {v4 .. v9}, Lcom/android/server/am/ActivityStack;->notifyEventLog(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v5, v6, Lcom/android/server/am/ActivityManagerService;->mHomeProcess:Lcom/android/server/am/ProcessRecord;
    ...
    iput-boolean v5, v0, Lcom/android/server/am/ActivityRecord;->sleeping:Z
    ...
    invoke-virtual {v5, v0}, Lcom/android/server/am/ActivityManagerService;->showUnsupportedZoomDialogIfNeededLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-virtual {v5, v0}, Lcom/android/server/am/ActivityManagerService;->showAskCompatModeDialogLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    iput-object v5, v0, Lcom/android/server/am/ActivityRecord;->compat:Landroid/content/res/CompatibilityInfo;

    .line 1305
    const/16 v22, 0x0

    .line 1306
    .local v22, "profilerInfo":Landroid/app/ProfilerInfo;
    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/android/server/am/ActivityStackSupervisor;->mService:Lcom/android/server/am/ActivityManagerService;

    iget-object v5, v5, Lcom/android/server/am/ActivityManagerService;->mProfileApp:Ljava/lang/String;
    ...
    iget-object v5, v5, Lcom/android/server/am/ActivityManagerService;->mProfileProc:Lcom/android/server/am/ProcessRecord;
    ...
    iput-object v0, v5, Lcom/android/server/am/ActivityManagerService;->mProfileProc:Lcom/android/server/am/ProcessRecord;
    ...
    iget-object v0, v5, Lcom/android/server/am/ActivityManagerService;->mProfileFile:Ljava/lang/String;
    ...
    iget-object v0, v5, Lcom/android/server/am/ActivityManagerService;->mProfileFd:Landroid/os/ParcelFileDescriptor;

    move-object/from16 v29, v0
    :try_end_24c
    .catch Landroid/os/RemoteException; {:try_start_154 .. :try_end_24c} :catch_fe
    ...
    :try_end_251
    .catch Ljava/io/IOException; {:try_start_24e .. :try_end_251} :catch_3b1
    .catch Landroid/os/RemoteException; {:try_start_24e .. :try_end_251} :catch_fe
    ...
    :goto_252
    :try_start_252
    new-instance v22, Landroid/app/ProfilerInfo;

    .line 1327
    .end local v22    # "profilerInfo":Landroid/app/ProfilerInfo;
    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/android/server/am/ActivityStackSupervisor;->mService:Lcom/android/server/am/ActivityManagerService;

    iget v5, v5, Lcom/android/server/am/ActivityManagerService;->mSamplingInterval:I

    move-object/from16 v0, p0

    iget-object v6, v0, Lcom/android/server/am/ActivityStackSupervisor;->mService:Lcom/android/server/am/ActivityManagerService;

    iget-boolean v6, v6, Lcom/android/server/am/ActivityManagerService;->mAutoStopProfiler:Z
    ...
    invoke-direct {v0, v1, v2, v5, v6}, Landroid/app/ProfilerInfo;-><init>(Ljava/lang/String;Landroid/os/ParcelFileDescriptor;IZ)V
    ...
    iput-boolean v5, v0, Lcom/android/server/am/ProcessRecord;->pendingUiClean:Z
    ...
    iget-object v11, v11, Lcom/android/server/am/ActivityManagerService;->mConfiguration:Landroid/content/res/Configuration;
    ...
    iget-object v12, v0, Lcom/android/server/am/TaskRecord;->mOverrideConfig:Landroid/content/res/Configuration;
    ...
    iget-object v14, v0, Lcom/android/server/am/TaskRecord;->voiceInteractor:Lcom/android/internal/app/IVoiceInteractor;
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/server/am/ActivityManagerService;->isNextTransitionForward()Z
    ...
    const-string/jumbo v7, "Starting new heavy weight process "
    ...
    .line 1352
    const-string/jumbo v7, " when already running "
    ...
    iput-object v0, v5, Lcom/android/server/am/ActivityManagerService;->mHeavyWeightProcess:Lcom/android/server/am/ProcessRecord;
    ...
    :try_end_357
    .catch Landroid/os/RemoteException; {:try_start_252 .. :try_end_357} :catch_fe
    ...
    iput-boolean v5, v0, Lcom/android/server/am/ActivityRecord;->launchFailed:Z

    .line 1383
    move-object/from16 v0, p1

    invoke-virtual {v4, v0}, Lcom/android/server/am/ActivityStack;->updateLRUListLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    const-string/jumbo v7, " being launched, but already in LRU list"
    ...
    invoke-virtual {v4, v0}, Lcom/android/server/am/ActivityStack;->minimalResumeActivityLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    .line 1315
    .restart local v22    # "profilerInfo":Landroid/app/ProfilerInfo;
    ...
    :try_end_3b7
    .catch Ljava/io/IOException; {:try_start_3b4 .. :try_end_3b7} :catch_3bb
    .catch Landroid/os/RemoteException; {:try_start_3b4 .. :try_end_3b7} :catch_fe
    ...
    .local v28, "o":Ljava/io/IOException;
    goto :goto_3b7

    .line 1341
    .end local v22    # "profilerInfo":Landroid/app/ProfilerInfo;
    .end local v25    # "e":Ljava/io/IOException;
    .end local v28    # "o":Ljava/io/IOException;
    .end local v29    # "profileFd":Landroid/os/ParcelFileDescriptor;
    .end local v30    # "profileFile":Ljava/lang/String;
    :cond_3bd
    const/16 v20, 0x1
    ...
    iput-object v5, v0, Lcom/android/server/am/ActivityRecord;->state:Lcom/android/server/am/ActivityStack$ActivityState;
...
.method resizeDockedStackLocked(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Z)V
    ...
    :try_end_6d
    .catchall {:try_start_23 .. :try_end_6d} :catchall_85
...
.method startSpecificActivityLocked(Lcom/android/server/am/ActivityRecord;ZZ)V
    ...
    .line 1426
    sget-object v1, Lcom/motorola/kpi/Kpi6paTop$Tag;->AMS7:Lcom/motorola/kpi/Kpi6paTop$Tag;

    const/4 v0, 0x2

    new-array v2, v0, [Ljava/lang/Object;

    iget-object v0, p1, Lcom/android/server/am/ActivityRecord;->processName:Ljava/lang/String;
    ...
    :try_end_49
    .catch Landroid/os/RemoteException; {:try_start_31 .. :try_end_49} :catch_63
