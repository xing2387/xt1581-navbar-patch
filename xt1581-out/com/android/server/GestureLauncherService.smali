...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/GestureLauncherService$3;,
        Lcom/android/server/GestureLauncherService$4;,
...
.field private static DEBUG_NOTIFICATION:Z = false

.field private static final TAG:Ljava/lang/String; = "GestureLauncherService"


# instance fields
.field private mCameraAvailCallback:Landroid/hardware/camera2/CameraManager$AvailabilityCallback;
...
.field private mRearCameraAvailability:Landroid/util/ArraySet;
...
.method static synthetic -get10(Lcom/android/server/GestureLauncherService;)I
    .registers 2
...
.method static synthetic -get7(Lcom/android/server/GestureLauncherService;)Landroid/util/ArraySet;
    .registers 2

    iget-object v0, p0, Lcom/android/server/GestureLauncherService;->mRearCameraAvailability:Landroid/util/ArraySet;

    return-object v0
.end method

.method static synthetic -get8(Lcom/android/server/GestureLauncherService;)Z
    .registers 2
...
.method static synthetic -get9(Lcom/android/server/GestureLauncherService;)Landroid/database/ContentObserver;
    .registers 2
...
.method static synthetic -set4(Lcom/android/server/GestureLauncherService;Z)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/GestureLauncherService;->mStowed:Z
...
.method static synthetic -wrap1(Lcom/android/server/GestureLauncherService;Ljava/lang/String;)Z
    .registers 3
    .param p1, "cameraId"    # Ljava/lang/String;

    .prologue
    invoke-direct {p0, p1}, Lcom/android/server/GestureLauncherService;->isRearOrExternalCamera(Ljava/lang/String;)Z
...
.method static synthetic -wrap4(Lcom/android/server/GestureLauncherService;)V
    .registers 1
...
.method static synthetic -wrap5(Lcom/android/server/GestureLauncherService;)V
    .registers 1

    invoke-direct {p0}, Lcom/android/server/GestureLauncherService;->updateStowedListenerIfNecessary()V
...
.method static constructor <clinit>()V
    ...
    :goto_c
    sput-boolean v0, Lcom/android/server/GestureLauncherService;->DEBUG_NOTIFICATION:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/GestureLauncherService;->mRearCameraAvailability:Landroid/util/ArraySet;

    .line 462
    new-instance v0, Lcom/android/server/GestureLauncherService$3;

    invoke-direct {v0, p0}, Lcom/android/server/GestureLauncherService$3;-><init>(Lcom/android/server/GestureLauncherService;)V

    iput-object v0, p0, Lcom/android/server/GestureLauncherService;->mStowedListener:Landroid/hardware/SensorEventListener;

    .line 524
    new-instance v0, Lcom/android/server/GestureLauncherService$4;

    invoke-direct {v0, p0}, Lcom/android/server/GestureLauncherService$4;-><init>(Lcom/android/server/GestureLauncherService;)V

    .line 523
    iput-object v0, p0, Lcom/android/server/GestureLauncherService;->mCameraAvailCallback:Landroid/hardware/camera2/CameraManager$AvailabilityCallback;
...
.method private handleCameraLaunchGesture(ZI)Z
    ...
    :cond_17
    invoke-virtual {p0}, Lcom/android/server/GestureLauncherService;->isCameraModStowed()Z
...
.method private isRearOrExternalCamera(Ljava/lang/String;)Z
    .registers 9
    .param p1, "cameraId"    # Ljava/lang/String;
    ...
    .line 554
    iget-object v3, p0, Lcom/android/server/GestureLauncherService;->mContext:Landroid/content/Context;
    ...
    .line 560
    .end local v1    # "len_facing":I
    :catch_22
    move-exception v0

    .line 561
    .local v0, "e":Ljava/lang/Exception;
    const-string/jumbo v3, "GestureLauncherService"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v6, "Exception thrown when get camera characteristics"
...
.method private registerCameraAvailabilityListenerIfNecessary()V
    .registers 5
    ...
    const-string/jumbo v3, "com.motorola.hardware.mods"

    invoke-virtual {v2, v3}, Landroid/content/pm/PackageManager;->hasSystemFeature(Ljava/lang/String;)Z

    move-result v2

    iput-boolean v2, p0, Lcom/android/server/GestureLauncherService;->mSupportMods:Z

    .line 510
    iget-boolean v2, p0, Lcom/android/server/GestureLauncherService;->mSupportMods:Z
    ...
    const-string/jumbo v3, "CameraAvailability"

    invoke-direct {v2, v3}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;)V

    iput-object v2, p0, Lcom/android/server/GestureLauncherService;->mCameraHandlerThread:Landroid/os/HandlerThread;

    .line 516
    iget-object v2, p0, Lcom/android/server/GestureLauncherService;->mCameraHandlerThread:Landroid/os/HandlerThread;
    ...
    iget-object v2, p0, Lcom/android/server/GestureLauncherService;->mCameraAvailCallback:Landroid/hardware/camera2/CameraManager$AvailabilityCallback;
    ...
    .line 507
    .end local v0    # "cm":Landroid/hardware/camera2/CameraManager;
...
.method private registerCameraLaunchGesture(Landroid/content/res/Resources;)V
    ...
    iput-wide v8, p0, Lcom/android/server/GestureLauncherService;->mCameraGestureOnTimeMs:J

    .line 214
    iget-wide v8, p0, Lcom/android/server/GestureLauncherService;->mCameraGestureOnTimeMs:J

    iput-wide v8, p0, Lcom/android/server/GestureLauncherService;->mCameraGestureLastEventTime:J
    ...
    sget-boolean v4, Lcom/android/server/GestureLauncherService;->DEBUG_NOTIFICATION:Z

    if-eqz v4, :cond_41

    .line 221
    const-string/jumbo v4, "GestureLauncherService"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v8, "Camera launch gesture id: "
    ...
    invoke-virtual {v2, v0, v5}, Landroid/hardware/SensorManager;->getDefaultSensor(IZ)Landroid/hardware/Sensor;
    ...
    const-string/jumbo v8, "Sensor name (from XML): "
    ...
    .line 235
    const-string/jumbo v7, "GestureLauncherService"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v8, "mCameraLaunchSensor != null"
    ...
    const-string/jumbo v8, "Sensor name (object): "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget-object v8, p0, Lcom/android/server/GestureLauncherService;->mCameraLaunchSensor:Landroid/hardware/Sensor;
...
.method private registerStowedListenerIfNecessary()V
    .registers 6
    ...
    iget-object v2, p0, Lcom/android/server/GestureLauncherService;->mStowedSensor:Landroid/hardware/Sensor;
    ...
    .line 482
    .local v1, "stowedList":Ljava/util/List;, "Ljava/util/List<Landroid/hardware/Sensor;>;"
    ...
    iput-object v2, p0, Lcom/android/server/GestureLauncherService;->mStowedSensor:Landroid/hardware/Sensor;

    .line 484
    iget-object v2, p0, Lcom/android/server/GestureLauncherService;->mStowedListener:Landroid/hardware/SensorEventListener;

    iget-object v3, p0, Lcom/android/server/GestureLauncherService;->mStowedSensor:Landroid/hardware/Sensor;
    ...
    .end local v1    # "stowedList":Ljava/util/List;, "Ljava/util/List<Landroid/hardware/Sensor;>;"
    :cond_34
    :goto_34
    monitor-exit p0
    ...
    .restart local v1    # "stowedList":Ljava/util/List;, "Ljava/util/List<Landroid/hardware/Sensor;>;"
    :cond_36
    const/4 v2, 0x0
...
.method private unregisterStowedListenerIfNecessary()V
    .registers 4
    ...
    .line 496
    :try_start_1
    iget-boolean v1, p0, Lcom/android/server/GestureLauncherService;->mSupportMods:Z

    if-eqz v1, :cond_1e

    iget-object v1, p0, Lcom/android/server/GestureLauncherService;->mStowedSensor:Landroid/hardware/Sensor;
    ...
    .line 499
    iget-object v1, p0, Lcom/android/server/GestureLauncherService;->mStowedListener:Landroid/hardware/SensorEventListener;
    ...
    iput-object v1, p0, Lcom/android/server/GestureLauncherService;->mStowedSensor:Landroid/hardware/Sensor;
    ...
    iput-boolean v1, p0, Lcom/android/server/GestureLauncherService;->mStowed:Z
    :try_end_21
...
.method private updateCameraDoubleTapPowerEnabled()V
    ...
    .line 182
    .local v0, "enabled":Z
    sget-boolean v1, Lcom/android/server/GestureLauncherService;->DEBUG_NOTIFICATION:Z
    ...
    const-string/jumbo v3, "isCameraDoubleTapPowerSettingEnabled: "
...
.method private updateCameraRegistered()V
    ...
    invoke-static {v2, v3}, Lcom/android/server/GestureLauncherService;->isCameraLaunchSettingEnabled(Landroid/content/Context;I)Z

    move-result v0

    .line 169
    .local v0, "cameraGestureEnabled":Z
    sget-boolean v2, Lcom/android/server/GestureLauncherService;->DEBUG_NOTIFICATION:Z
    ...
    const-string/jumbo v4, "cameraGestureEnabled: "
    ...
    .line 174
    invoke-direct {p0, v1}, Lcom/android/server/GestureLauncherService;->registerCameraLaunchGesture(Landroid/content/res/Resources;)V
...
.method private updateStowedListenerIfNecessary()V
    .registers 4

    .prologue
    .line 567
    const-string/jumbo v1, "camera.mot.rc_id"
    ...
    .line 569
    invoke-direct {p0}, Lcom/android/server/GestureLauncherService;->registerStowedListenerIfNecessary()V
    ...
    .line 571
    :cond_e
    invoke-direct {p0}, Lcom/android/server/GestureLauncherService;->unregisterStowedListenerIfNecessary()V
...
.method public isBackOrExternalCameraUnavailable()Z
    .registers 3
    ...
    .line 577
    :try_start_2
    iget-object v1, p0, Lcom/android/server/GestureLauncherService;->mRearCameraAvailability:Landroid/util/ArraySet;
...
.method public isCameraModStowed()Z
    .registers 2

    .prologue
    .line 582
    iget-boolean v0, p0, Lcom/android/server/GestureLauncherService;->mSupportMods:Z

    if-eqz v0, :cond_7

    iget-boolean v0, p0, Lcom/android/server/GestureLauncherService;->mStowed:Z
...
.method public onBootPhase(I)V
    ...
    .line 152
    invoke-direct {p0}, Lcom/android/server/GestureLauncherService;->registerCameraAvailabilityListenerIfNecessary()V
